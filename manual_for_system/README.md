...
バージョン0.5以降は0.01刻みで更新しています。開発中のため先頭に0を付けた表記です。
...
- `manual_for_system/2025-08-01-site-renewal.md`
  サイトリニューアルのお知らせを掲載したMarkdownファイル。2025年8月1日に更新し、旧サイトから順次移行する旨を告知しています。
- `next.config.js`  
